...
//                 - If the queried GPU is not part of a active SLI group.
//
//  SUPPORTED OS: Windows XP and higher
//
// RETURN STATUS: NVAPI_INVALID_ARGUMENT: hPhysicalGpu or pOutputsMask is NULL
...
//
// PARAMETERS:      hPhysicalGpu(IN)          - Physical GPU Handle.
//                  NV_BOARD_INFO(IN/OUT)     - Board Information.
//
// RETURN STATUS:
//                  NVAPI_OK - completed request
//                  NVAPI_ERROR - miscellaneous error occurred
...
//
// PARAMETERS:      displayId(IN)                - Monitor Identifier
//                  pMonitorCapabilities(IN/OUT) - The monitor support info
//
// RETURN STATUS:
//                  NVAPI_OK - completed request
//                  NVAPI_ERROR - miscellaneous error occurred
...
#define NVVIOCAPS_PACKED_ANC_SUPPORTED      0x00200000      // Supports Packed ANC
